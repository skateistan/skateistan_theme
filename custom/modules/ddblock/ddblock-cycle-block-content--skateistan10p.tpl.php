         ...
         <div class="slide-text slide-text-<?php print $settings['slide_direction'] ?> slide-text-<?php print $settings['slide_text_position'] ?> clearfix">
          <div class="slide-text-inner clearfix">
           <?php if ($settings['slide_text'] == 1) :?>
            <?php if (isset($slider_item['slide_title'])) :?>
             <div class="slide-title slide-title-<?php print $settings['slide_direction'] ?> clearfix">
              <div class="slide-title-inner clearfix">
               <h4><?php print $slider_item['slide_title'] ?></h4>
            ...
            <?php endif; ?>
           <?php endif; ?>
            <div class="slide-action-links clear-block border"> <!-- find out more and take action links-->
            <div class="diamond_left"></div>
            <?php if (!empty($slider_item['slide_read_more_link'])) :?>
            <div class="slide-info">
              <a class="slide-more-info" href="<?php print $slider_item['slide_read_more_link'] ?>"><?php print $slider_item['slide_read_more_title'] ?></a>
            </div>
            <?php endif; ?>
            <?php if (!empty($slider_item['slide_take_action_link'])) :?>
            <div class="slide-action">
              <a class="slide-take-action" href="<?php print $slider_item['slide_take_action_link'] ?>"><?php print $slider_item['slide_take_action_title'] ?></a>
            </div>
            <?php endif; ?> 
